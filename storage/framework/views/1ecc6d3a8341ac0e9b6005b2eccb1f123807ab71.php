...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
              <a href="<?php echo e(url('carstype/create')); ?>" id="btnadd" style="margin-bottom: 20px;"class="btn btn-primary "><i class="fa fa-plus"></i> Create Car Type</a>
              ...
              <?php $__currentLoopData = $carstype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cartype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a id="borrar" class="btn btn-danger borrar" href="<?php echo e(route('cartypeDestroy',[$cartype->car_type_id])); ?>"><i class="fa fa-remove">
                </i></a>
                  </td>
