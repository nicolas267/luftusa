...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo e(Request::root()); ?>/public/css/skins/skin-black.css" rel="stylesheet"/>
...
<body class="skin-black sidebar-mini">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header" style="height: 90px;">
                                    <p>
                                        ...
                                        <small>
                                            Member since <?php echo e(ucwords(auth()->user()->created_at)); ?>
    ...
    <script src="<?php echo e(Request::root()); ?>/public/plugins/input-mask/jquery.inputmask.extensions.js">
    </script>
</body>
...
<script src="<?php echo e(Request::root()); ?>/public/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js">
</script>
<!--Data Tables -->
<!-- AdminLTE App -->
